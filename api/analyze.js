/**
 * Vercel serverless function - proxies file analysis requests to Anthropic API.
 * Accepts messages with multimodal content (text, images, PDFs) and forwards to Claude.
 */
